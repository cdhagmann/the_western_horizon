...
> "Changed our game's culture from one where we told the stories and the players observed to one where we all explored and discovered the story of our game together."
...
**Goal refresh:** Players invent new goals as they complete old ones.

### Factions as "The GM's Party"

> "It's too complicated to track the goals and attitudes of every single NPC in the game. Instead, focus on tracking the goals of the factions that your NPCs belong to."
...
Vary conflict types to avoid "frustrating slog" of constant direct opposition.
...
### Building Locations Around Goals

Locations don't have goals, but should be built around player goals:
- Some goals name specific locations → design those
- Others imply location types → create appropriate venues
- Work backward: "What would a satisfying conclusion look like?"
...
Traditional West Marches uses a **bulletin board** of GM-created hooks. Proactive play inverts this:
...
**The problem:** Responsive generation needs player intent, but players need *something* to react to.

**The solution:** Players bring goals from character creation. The GM doesn't need to create hooks—they create *obstacles* to player-declared goals.
...
Factions from Ex Novo and Beak, Feather & Bone gain:
- **Concrete goals** (not just "identity" and "resources")
- **Clocks** tracking progress
- **Between-session advancement** creating emergent pressure

### Session Zero Additions

Add to Session Zero:
1. Each PC creates 3 goals (short/medium/long-term)
2. Use "What would it look like when you reach your goal?" to refine
3. GM identifies overlaps with starting faction goals
4. Initial obstacles seeded from goal/faction collision
...
> "The encounter, not the adventure, is the fundamental unit of play. String enough encounters together and an adventure with a very clear arc will emerge from the conflict and actions players take to resolve it."

> "Make sure your factions have goals that relate to the same people, places and events as your PC's goals."

> "If you can fail at achieving a goal only to try it again, then it doesn't mean anything to fail."

> "Enlist your player's help in designing content" by asking "What would it look like when you reach your goal?"

## Adaptation Notes

For The Western Horizon:
- Goals don't replace responsive generation—they **trigger** it
- Faction goals come from Ex Novo/BF&B faction creation, then get refined with specific objectives
